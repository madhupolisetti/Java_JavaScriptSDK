...
import com.smscountry.restapi.client.sms.SmsRequest;
import com.smscountry.restapi.client.sms.SmsResponse;
...
public class CallClientImpl extends GenericClient implements CallClient {
	...
	@Override
	public CallResponse getCallList(String fromDate, String toDate, String senderId) {
